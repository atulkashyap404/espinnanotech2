...
export default function BoardPage() {
  return (
    <main className="min-h-screen pt-20">
      <div className="relative h-[20vh] flex items-center justify-center overflow-hidden mb-4">
        <div 
        ...
        >
          ...
          <p className="text-lg text-gray-200 max-w-2xl mx-auto">
            Meet the visionary leaders driving innovation in nanofiber technology
          </p>
