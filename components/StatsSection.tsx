...
export function StatsSection() {
  return (
    <section className="relative min-h-[60vh] px-4 md:px-6 py-12 overflow-hidden flex items-center dark:bg-black bg-white  dark:bg-grid-small-white/[0.2] bg-grid-small-black/[0.2]">
      {/* Background Image */}
      {/* <div
