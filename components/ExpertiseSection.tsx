...
export function ExpertiseSection() {
  return (
    <section className="px-4 md:px-6 py-12 bg-gradient-to-r from-gray-50 to-gray-200">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row gap-12 items-center">
          ...
          <div className="flex-1 relative group transition-transform duration-500 ease-in-out hover:scale-105">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
          </div>
